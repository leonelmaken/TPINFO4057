...
public class StudentBean extends UserBean{
	...
	public StudentBean(byte[] photocniFile, byte[] relevebacFile, byte[] releveprobaFile, byte[] actenaissFile,
			byte[] recuFile, String premierchoix, String deuxiemechoix, String troisiemechoix, SpecialiteBean specialite,
			NiveauBean niveau, String dernierdiplom, String anneeObtent, Double moyenne, String infojury,
	...
	public SpecialiteBean getSpecialite() {
		return specialite;
	}
	public void setSpecialite(SpecialiteBean specialite) {
		this.specialite = specialite;
	}
	public NiveauBean getNiveau() {
		return niveau;
	}
	public void setNiveau(NiveauBean niveau) {
		this.niveau = niveau;
	}
