...
public class StudentBean extends UserBean{
	...
	public StudentBean(String photocni, String relevebac, String releveproba, String actenaiss, String recu,
			String premierchoix, String deuxiemechoix, String troisiemechoix, String specialite,
	...
	public String toString() {
		return "Student [photocni=" + photocni + ", relevebac=" + relevebac + ", releveproba=" + releveproba
				...
				+ deuxiemechoix + ", troisiemechoix=" + troisiemechoix + ", specialite=" + specialite + ", dernierdiplom=" + dernierdiplom + ", anneeObtent=" + anneeObtent + ", moyenne=" + moyenne
