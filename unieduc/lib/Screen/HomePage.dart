...
import 'package:unieduc/Screen/AddAnnonce.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: ListView(
          ...
          children: <Widget>[
            DrawerHeader(
              decoration: const BoxDecoration(
                gradient: LinearGradient(
                    ...
                    colors: [PRIMARY_COLOR, Color.fromARGB(255, 38, 83, 129)]),
                // color: Colors.blue,
              ),
              child: Center(
            ...
            Visibility(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: selected_drawer == 1
                        ? const Color.fromARGB(255, 229, 242, 248)
                        : null),
                child: ListTile(
            ...
            Visibility(
              ...
              child: Container(
                decoration: BoxDecoration(
                    color: selected_drawer == 22
                        ? const Color.fromARGB(255, 229, 242, 248)
                        : null),
                child: ListTile(
                  leading: const Icon(Icons.school),
                  title: const Text("Se preinscrire a l'universite",
                      style: TextStyle(color: TEXT_COLOR, fontSize: 17)),
                  onTap: () async {
                    await colorDrawer(22);
                    Navigator.push(
                        context,
                        PageRouteBuilder(
                ...
                child: ListTile(
                  ...
                  onTap: () async {
                    ...
                    Navigator.push(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (_, __, ___) => const Parametres(),
                        ));
                  },
                ),
              ),
            ...
            Visibility(
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  onTap: () async {
                    await colorDrawer(5);
                    Share.shareUri(Uri.parse("https://t.me/loupgarrou"));
                  },
                ),
              ),
            ),
      ...
      body:
          ...
          //                             context,
          //                             PageRouteBuilder(
          //                               pageBuilder: (_, __, ___) =>  AddAnnonce(),
          //                             ));
          //                                 },
          //                                 child: Container(
          //                             height: 30,
          ...
          //                                     child: const Text(
          //                                       "Le travail est très important, cela éloigne de nous trois grands maux: L'ennuis, le vice et le besoin",
          //                                       style: TextStyle(
          //                                           color: Colors.black,
          //                                           fontSize: 12),
          //                                     ),
          ...
          //                                   child: Container(
          //                                     child: Image.asset(
          //                                       "assets/images/fc7ea768-how-to-reduce-the-waiting-time-in-your-restaurant-fr.png",
                              ...
                              children: [
                                ...
                                Visibility(
                                  ...
                                  child: Container(
                                    margin: EdgeInsets.all(10),
                                    child: const Text(
                                      "Le travail est très important, cela éloigne de nous trois grands maux: L'ennui, le vice et le besoin",
                                      style: TextStyle(
