...
class FicheInscription extends StatefulWidget {
  const FicheInscription({super.key});

  @override
  State<FicheInscription> createState() => _FicheInscriptionState();
}

class _FicheInscriptionState extends State<FicheInscription> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(
       child: Text("Votre fiche d'inscription est ici",style: TextStyle(
        color: TEXT_COLOR,
       ),)
      ),
    );
